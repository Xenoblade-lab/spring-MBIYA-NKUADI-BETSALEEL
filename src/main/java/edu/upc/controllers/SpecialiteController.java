...
public class SpecialiteController {
	...
	public String list(Model model) {
		...
		return "specialites-view";
	}

	@GetMapping("/create")
	public String createForm(Model model) {
		model.addAttribute("form", new SpecialiteDto());
		return "specialites-form";
	}

	@GetMapping("/{id}/edit")
	public String editForm(@PathVariable("id") long id, Model model) {
		model.addAttribute("form", mapper.toSpecialiteDto(service.getById(id)));
	...
	public String save(@RequestParam(value = "id", required = false) Long id,
			@Valid @ModelAttribute("form") SpecialiteDto form, BindingResult result, Model model,
