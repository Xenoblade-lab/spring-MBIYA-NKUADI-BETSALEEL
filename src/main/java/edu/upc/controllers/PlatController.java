...
public class PlatController {
	...
	public String createForm(Model model) {
		model.addAttribute("form", new PlatDto());
		return "plats-form";
	}

	@GetMapping("/{id}/edit")
	public String editForm(@PathVariable("id") long id, Model model) {
		model.addAttribute("form", mapper.toPlatDto(service.getById(id)));
	...
	public String save(@RequestParam(value = "id", required = false) Long id,
			@Valid @ModelAttribute("form") PlatDto form, BindingResult result, Model model,
