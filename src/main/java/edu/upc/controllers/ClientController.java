...
public class ClientController {
	...
	public String createForm(Model model) {
		prepareForm(model, new ClientDto(), null);
		return "clients-form";
	}

	@GetMapping("/{id}/edit")
	public String editForm(@PathVariable("id") long id, Model model) {
		prepareForm(model, mapper.toClientDto(service.getById(id)), id);
		return "clients-form";
	}

	@PostMapping("/save")
	public String save(@RequestParam(value = "id", required = false) Long id,
			@Valid @ModelAttribute("form") ClientDto form, BindingResult result, Model model,
	...
	private void prepareForm(Model model, ClientDto form, Long id) {
